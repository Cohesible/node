'use strict';
const { ERR_INVALID_ARG_VALUE, ERR_WASI_ALREADY_STARTED, } = require('internal/errors').codes;
const { emitExperimentalWarning, kEmptyObject, } = require('internal/util');
const { validateArray, validateBoolean, validateFunction, validateInt32, validateObject, validateString, validateUndefined, } = require('internal/validators');
...
class WASI {
    constructor(options = kEmptyObject) {
        ...
        if (options.preopens !== undefined) {
            ...
            Object.entries(options.preopens).forEach(({ 0: key, 1: value }) => preopens.push(String(key), String(value)));
        }
