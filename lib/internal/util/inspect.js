...
function addPrototypeProperties(ctx, main, obj, recurseTimes, output) {
    ...
    do {
        ...
        for (const key of keys) {
            ...
            if (key === 'constructor' || Object.prototype.hasOwnProperty.call(main, key) ||
...
function getKeys(value, showHidden) {
    ...
    if (showHidden) {
        ...
        if (symbols.length !== 0) {
            ...
            ArrayPrototypePushApply(keys, symbols.filter(filter));
        }
    }
    return keys;
}
    ...
    if (typeof tag !== 'string' ||
        (tag !== '' &&
            (ctx.showHidden ?
                ...
                ObjectPrototypePropertyIsEnumerable)(value, Symbol.toStringTag))) {
        tag = '';
    }
    let base = '';
