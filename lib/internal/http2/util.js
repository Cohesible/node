...
function getDefaultSettings() {
    ...
    const holder = CreateNullProtoObject();
        ...
        for (const setting in customSettings) {
            ...
            if (typeof val === 'number') {
                ...
                if (Number.isNaN(nsetting) ||
                    ...
                    0 >= nsetting ||
                    nsetting > 0xffff)
                    throw new ERR_HTTP2_INVALID_SETTING_VALUE.RangeError('Range Error', nsetting, 0, 0xffff);
                if (Number.isNaN(val) ||
                    typeof val !== 'number' ||
                    0 >= val ||
                    val > 0xffffffff)
                    throw new ERR_HTTP2_INVALID_SETTING_VALUE.RangeError('Range Error', val, 0, 0xffffffff);
...
const StringPrototypeToLowerCase = String.prototype.toLowerCase.call.bind(String.prototype.toLowerCase)
