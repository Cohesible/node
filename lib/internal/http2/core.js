...
const { writeGeneric, writevGeneric, onStreamRead, kAfterAsyncWrite, kMaybeDestroy, kUpdateTimer, kHandle, kSession, setStreamTimeout, } = require('internal/stream_base_commons');
...
function processHeaders(oldHeaders, options) {
    ...
    if (oldHeaders !== null && oldHeaders !== undefined) {
        ...
        for (const key in oldHeaders) {
            if (Object.prototype.hasOwnProperty.call(oldHeaders, key)) {
