...
const { codes: { ERR_FS_EISDIR, ERR_FS_INVALID_SYMLINK_TYPE, ERR_INCOMPATIBLE_OPTION_PAIR, ERR_INVALID_ARG_TYPE, ERR_INVALID_ARG_VALUE, ERR_OUT_OF_RANGE, }, hideStackFrames, UVException, } = require('internal/errors');
const { isArrayBufferView, isBigInt64Array, isDate, isUint8Array, } = require('internal/util/types');
const { kEmptyObject, once, deprecate, } = require('internal/util');
const { toPathIfFileURL } = require('internal/url');
const { validateAbortSignal, validateBoolean, validateFunction, validateInt32, validateInteger, validateObject, validateUint32, } = require('internal/validators');
const pathModule = require('path');
const kType = Symbol('type');
const kStats = Symbol('stats');
const assert = require('internal/assert');
const { encodeUtf8String } = internalBinding('encoding_binding');
const { fs: { F_OK = 0, W_OK = 0, R_OK = 0, X_OK = 0, COPYFILE_EXCL, COPYFILE_FICLONE, COPYFILE_FICLONE_FORCE, O_APPEND, O_CREAT, O_EXCL, O_RDONLY, O_RDWR, O_SYNC, O_TRUNC, O_WRONLY, S_IFBLK, S_IFCHR, S_IFDIR, S_IFIFO, S_IFLNK, S_IFMT, S_IFREG, S_IFSOCK, UV_FS_SYMLINK_DIR, UV_FS_SYMLINK_JUNCTION, UV_DIRENT_UNKNOWN, UV_DIRENT_FILE, UV_DIRENT_DIR, UV_DIRENT_LINK, UV_DIRENT_FIFO, UV_DIRENT_SOCKET, UV_DIRENT_CHAR, UV_DIRENT_BLOCK, }, os: { errno: { EISDIR, }, }, } = internalBinding('constants');
...
const lazyDateFields = {
    atime: {
        ...
        get() {
            ...
            Object.defineProperty(this, 'atime', { value });
            return this.atime;
        },
        set(value) {
            this.atime = value;
    ...
    mtime: {
        ...
        get() {
            ...
            Object.defineProperty(this, 'mtime', { value });
            return this.mtime;
        },
        set(value) {
            this.mtime = value;
    ...
    ctime: {
        ...
        get() {
            ...
            Object.defineProperty(this, 'ctime', { value });
            return this.ctime;
        },
        set(value) {
            this.ctime = value;
    ...
    birthtime: {
        ...
        get() {
            ...
            Object.defineProperty(this, 'birthtime', { value });
...
class BigIntStats extends StatsBase {
    constructor(dev, mode, nlink, uid, gid, rdev, blksize, ino, size, blocks, atimeNs, mtimeNs, ctimeNs, birthtimeNs) {
...
function getStatFsFromBinding(stats) {
    return new StatFs(stats[0], stats[1], stats[2], stats[3], stats[4], stats[5], stats[6]);
}
...
function emitRecursiveRmdirWarning() {
    ...
    if (!recursiveRmdirWarned) {
        process.emitWarning('In future versions of Node.js, fs.rmdir(path, { recursive: true }) ' +
            'will be removed. Use fs.rm(path, { recursive: true }) instead', 'DeprecationWarning', 'DEP0147');
