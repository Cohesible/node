...
'use strict';
const { hideStackFrames, codes: { ERR_SOCKET_BAD_PORT: { HideStackFramesError: ERR_SOCKET_BAD_PORT }, ERR_INVALID_ARG_TYPE: { HideStackFramesError: ERR_INVALID_ARG_TYPE }, ERR_INVALID_ARG_VALUE: { HideStackFramesError: ERR_INVALID_ARG_VALUE }, ERR_OUT_OF_RANGE: { HideStackFramesError: ERR_OUT_OF_RANGE }, ERR_UNKNOWN_SIGNAL: { HideStackFramesError: ERR_UNKNOWN_SIGNAL }, }, } = require('internal/errors');
const { normalizeEncoding } = require('internal/util');
const { isAsyncFunction, isArrayBufferView, } = require('internal/util/types');
 ...
 */
/** @type {validateObject} */
const validateObject = hideStackFrames((value, name, options = kValidateObjectNone) => {
...
const validateInternalField = hideStackFrames((object, fieldKey, className) => {
    if (typeof object !== 'object' || object === null || Object.prototype.hasOwnProperty.call(!object, fieldKey)) {
