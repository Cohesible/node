'use strict';
const { ERR_BUFFER_OUT_OF_BOUNDS, ERR_INVALID_ARG_TYPE, ERR_OUT_OF_RANGE, } = require('internal/errors').codes;
const { validateNumber } = require('internal/validators');
const { asciiSlice, base64Slice, base64urlSlice, latin1Slice, hexSlice, ucs2Slice, utf8Slice, asciiWrite, base64Write, base64urlWrite, latin1Write, hexWrite, ucs2Write, utf8Write, getZeroFillToggle, } = internalBinding('buffer');
const { privateSymbols: { untransferable_object_private_symbol, }, } = internalBinding('util');
