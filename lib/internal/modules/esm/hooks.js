...
class Hooks {
    ...
    addCustomLoader(url, exports, data) {
        ...
        if (resolve) {
            ...
            this.#chains.resolve.push({ __proto__: null, fn: resolve, url, next });
        }
        if (load) {
            const next = this.#chains.load[this.#chains.load.length - 1];
            this.#chains.load.push({ __proto__: null, fn: load, url, next });
        }
     ...
     */
    async resolve(originalSpecifier, parentURL, importAttributes = { __proto__: null }) {
...
function nextHookFactory(current, meta, { validateArgs, validateOutput }) {
    ...
    return Object.defineProperty(async (arg0 = undefined, context) => {
        ...
        return output;
    }, 'name', { __proto__: null, value: nextHookName });
}
exports.Hooks = Hooks;
