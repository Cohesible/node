...
const { vm_dynamic_import_default_internal, vm_dynamic_import_main_context_default, vm_dynamic_import_missing_flag, vm_dynamic_import_no_callback, } = internalBinding('symbols');
...
const { emitExperimentalWarning, getCWDURL, getLazy, } = require('internal/util');
...
const getCascadedLoader = getLazy(() => require('internal/process/esm_loader').esmLoader);
/**
