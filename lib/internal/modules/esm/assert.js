...
const { ERR_IMPORT_ATTRIBUTE_TYPE_INCOMPATIBLE, ERR_IMPORT_ATTRIBUTE_MISSING, ERR_IMPORT_ATTRIBUTE_UNSUPPORTED, } = require('internal/errors').codes;
 ...
 */
const supportedAssertionTypes = Object.values(formatTypeMap).filter((type) => type !== kImplicitAssertType);
/**
 ...
 */
function validateAttributes(url, format, importAttributes = { __proto__: null }) {
    ...
    switch (validType) {
        ...
        case kImplicitAssertType:
            ...
            if (!Object.prototype.hasOwnProperty.call(importAttributes, 'type')) {
                return true;
            }
