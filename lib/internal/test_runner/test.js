...
function stopTest(timeout, signal) {
    ...
    if (timeout === kDefaultTimeout) {
        disposeFunction = abortListener[Symbol.for("dispose")];
    }
    else {
        ...
        disposeFunction = () => {
            abortListener[Symbol.for("dispose")]();
            timer[Symbol.for("dispose")]();
        };
    }
    Object.defineProperty(deferred.promise, Symbol.for("dispose"), {
        configurable: true,
        writable: true,
...
class Test extends AsyncResource {
    ...
    async run() {
        ...
        try {
            ...
            stopPromise?.[Symbol.for("dispose")]();
