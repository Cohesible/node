...
// const staticFields = { __proto__: null }
// const instanceFields = { __proto__: null }
// const instanceGet = { __proto__: null }
// const instanceSet = { __proto__: null }

// primordials.getMappings = () => {
//   return {
//     staticFields,
//     instanceFields,
//     instanceGet,
...
// function copyAccessor(dest, prefix, key, { enumerable, get, set }, n = key) {
//   instanceGet[`${prefix}Get${key}`] = n
...
// function copyPropsRenamed(src, dest, prefix, source = prefix) {
//   for (const key of ReflectOwnKeys(src)) {
//     const newKey = getNewKey(key);
//     const desc = ReflectGetOwnPropertyDescriptor(src, key);
//     const q = typeof key === 'string' ? `${source}.${key}` : undefined
//     if ('get' in desc) {
//       copyAccessor(dest, prefix, newKey, desc, q);
//     } else {
//       const name = `${prefix}${newKey}`;
//       staticFields[name] = q
//       ReflectDefineProperty(dest, name, { __proto__: null, ...desc });
//       if (varargsMethods.includes(name)) {
//         // reverseMap.set(`${name}Apply`, source)
...
// function copyPropsRenamedBound(src, dest, prefix, source = prefix) {
//   for (const key of ReflectOwnKeys(src)) {
//     const newKey = getNewKey(key);
//     const desc = ReflectGetOwnPropertyDescriptor(src, key);
//     if ('get' in desc) {
//       copyAccessor(dest, prefix, newKey, desc, source);
//     } else {
//       const { value } = desc;
...
// function copyPrototype(src, dest, prefix, source = prefix) {
//   for (const key of ReflectOwnKeys(src)) {
//     const newKey = getNewKey(key);
//     const desc = ReflectGetOwnPropertyDescriptor(src, key);
//     if ('get' in desc) {
...
//       const name = `${prefix}${newKey}`;
//       instanceFields[name] = typeof key === 'string' ? key : undefined
//       ReflectDefineProperty(dest, name, { __proto__: null, ...desc });
//       if (varargsMethods.includes(name)) {
//         ReflectDefineProperty(dest, `${name}Apply`, {
//           __proto__: null,
...
// primordials.Symbol.dispose ??= primordials.SymbolFor('nodejs.dispose');
// primordials.Symbol.asyncDispose ??= primordials.SymbolFor('nodejs.asyncDispose');
...
//           desc.value.length === 0 &&
//           Symbol.iterator in (FunctionPrototypeCall(desc.value, dummy) ?? {})
//         ) {
...
//       PromisePrototypeThen(Promise.resolve(promise), (result) => {
//         returnVal[i] = result;
...
//       const promise = mapFn != null ? mapFn(promises[i], i) : promises[i];
//       PromisePrototypeThen(Promise.resolve(promise), onFulfilled, reject);
//     }
//   });
...
//   for (let i = 0; i < promises.length; i++) {
//     const promise = mapFn != null ? mapFn(promises[i], i) : promises[i];
//     PromisePrototypeThen(Promise.resolve(promise), onSettle, onSettle);
//   }
// });
...
primordials.SafeMap = globalThis.Map
primordials.SafeSet =  globalThis.Set
primordials.SafeWeakMap = globalThis.WeakMap
primordials.SafeWeakSet =  globalThis.WeakSet
