...
const { ERR_INVALID_ARG_TYPE, ERR_STREAM_NULL_VALUES, } = require('internal/errors').codes;
function from(Readable, iterable, opts) {
    ...
    readable._destroy = function (error, cb) {
        close(error).then(() => process.nextTick(cb, error), // nextTick is here in case cb throws
