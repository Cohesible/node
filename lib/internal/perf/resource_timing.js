'use strict';
const { codes: { ERR_ILLEGAL_CONSTRUCTOR, }, } = require('internal/errors');
...
class PerformanceResourceTiming extends PerformanceEntry {
    ...
    get transferSize() {
        validateInternalField(this, kTimingInfo, 'PerformanceResourceTiming');
        if (this[kCacheMode] === 'local')
            return 0;
        if (this[kCacheMode] === 'validated')
            return 300;
...
function markResourceTiming(timingInfo, requestedUrl, initiatorType, global, cacheMode) {
    ...
    const resource = createPerformanceResourceTiming(requestedUrl, initiatorType, timingInfo, cacheMode);
    enqueue(resource);
