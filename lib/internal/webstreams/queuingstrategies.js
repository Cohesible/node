'use strict';
const { codes: { ERR_MISSING_OPTION, }, } = require('internal/errors');
 ...
 * }} QueuingStrategy
 */
const nameDescriptor = { value: 'size' };
const byteSizeFunction = Object.defineProperty((chunk) => chunk.byteLength, 'name', nameDescriptor);
